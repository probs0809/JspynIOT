...
public class dashBoard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pre_loader = findViewById(R.id.loader);
        my_drawer_layout = findViewById(R.id.dl);
        ...
        toggle_drawer = findViewById(R.id.addDevice);
        ...
        final ImageView headerImageView = headerView.findViewById(R.id.imgView);
        final TextView headerEmailText = headerView.findViewById(R.id.imgText);
        final TextView headerUsername = headerView.findViewById(R.id.usrName);
